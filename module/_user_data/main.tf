...
locals {
  template_path = {
    al2023       = "${path.root}/templates/al2023_user_data.tpl"
    bottlerocket = "${path.root}/templates/bottlerocket_user_data.tpl"
    linux        = "${path.root}/templates/linux_user_data.tpl"
    windows      = "${path.root}/templates/windows_user_data.tpl"
  }
